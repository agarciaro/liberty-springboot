...
@Service("productosServiceMock")
@RequiredArgsConstructor
@ConditionalOnProperty(name = "productos-service-impl-name", havingValue = "ProductosServiceImpl2")
public class ProductosServiceImpl2 implements ProductosService {
